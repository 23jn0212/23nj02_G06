...
<body>
    ...
    <div class="row" id="detailsize">
        ...
        <div class="col-4 offset-2" >
            <img src="images/遊戯王クリボー.jpg" class="ex1">
        </div>
        ...
        <div class="col-5">
            <table class="table table-bordered">
                ...
                <tr class="table-warning">
                    <td>
                    【 悪魔族・効果 】<br>
                     ATK/ 300 / DEF/ 200 / 星1<br>

                    <br>
                    相手のターンの戦闘ダメージ計算時、このカードを手札<br>
                    から捨てて発動できる。その戦闘によって発生する<br>
                    自分への戦闘ダメージは0になる。
                    </td>
                </tr>
    ...
    <div class="row box" id="boxsize">
        ...
        <div class="col-2">
            <table align="left">
                <tr>
                    <td>
                        <img src="images/遊戯王クリボー.jpg" class="ex2">
                    </td>
                </tr>
                <tr>
                    <td>
